...
public class HelloWorldSwing3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HelloWorldSwing3 frame = new HelloWorldSwing3();
	...
	public HelloWorldSwing3() {
		...
		chckbxNewCheckBox = new JCheckBox("Clear After:");
		...
		btnShow.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if(chckbxNewCheckBox.isSelected() && Integer.parseInt(textField.getText()) >= 1 && Integer.parseInt(textField.getText()) <= 10){
					javax.swing.Timer timer = new javax.swing.Timer(Integer.parseInt(textField.getText()) * 1000, new ActionListener(){
				...
				} else if(chckbxNewCheckBox.isSelected() && Integer.parseInt(textField.getText()) < 1 || Integer.parseInt(textField.getText()) > 10 ){
